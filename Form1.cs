...
namespace ZodObfuscator
{
    public partial class Form1 : MetroFramework.Forms.MetroForm
    {
            ...
            foreach (TypeDef type in mod.Types)
            {
                ...
                else
                {
                    foreach (PropertyDef property in type.Properties)
                    {
                        ...
                        property.Name = RandomString(20) + "hfdsjhdkljhkjhfdjs";
                    }
                    foreach (FieldDef fields in type.Fields)
                    {
                        fields.Name = RandomString(20) + "hfdsjhdkljhkjhfdjs";
                    }
                    foreach (EventDef eventdef in type.Events)
                    {
                        eventdef.Name = RandomString(20) + "hfdsjhdkljhkjhfdjs";
                    }
        ...
        public void junkattrib(ModuleDefMD module)
        {
            ...
            {
                var junkatrb = new TypeDefUser("hfdsjhdkljhkjhfdjs" + RandomString(20), "hfdsjhdkljhkjhfdjs" + RandomString(20), module.CorLibTypes.Object.TypeDefOrRef);
